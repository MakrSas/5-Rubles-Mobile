...
class HScript implements IScript implements flixel.util.FlxDestroyUtil.IFlxDestroyable
{
	...
	public static function getDefaultVariables():Map<String, Dynamic>
	{
		return [
			...
			// Compatibility alias for old gameplay scripts
			"JopaScaleMode" => game.backend.system.scripts.JopaScaleModeCompat,
			...
			"NewFreeplay" => game.states.FreeplayState,
			"SongsState" => game.states.editors.SongsState,
