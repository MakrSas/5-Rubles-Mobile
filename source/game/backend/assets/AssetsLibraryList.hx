...
class AssetsLibraryList extends AssetLibrary
{
	...
	public function unloadLibraries()
	{
		#if !html5
		for (l in libraries)
			if (l != null && !__defaultLibraries.contains(l))
				l.unload();
		#end
	}
	...
	public function disposeLibraries()
	{
		#if !html5
		for (l in libraries)
			if (l != null && !__defaultLibraries.contains(l) && (l : Dynamic).dispose != null)
				(l : Dynamic).dispose();
		#end
	}
	...
	public function disposeAllLibraries()
	{
		#if !html5
		for (l in libraries)
			if (l != null && (l : Dynamic).dispose != null)
				(l : Dynamic).dispose();
		#end
	}
