class ObjectIntervalShake extends FlxBasic
{
    ...
    private var object:FlxObject = null;
    ...
    function start(strums:FlxObject, Duration:Float = 1, Interval:Float = 0.04, StartIntensity:Float = 0, EndIntensity:Float = 0, Ease:EaseFunction,
